...
Eric: This code originated from the Realm of Racket chapter8 source
code. Modifications and refactorings are my own. I'm going to refactor
this until it does not mutate state.
